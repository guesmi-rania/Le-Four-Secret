        ...
        {cart.length === 0 ? (
          ...
          <>
            ...
            <div className="cart-summary">
              ...
              <p>Sous-total : {cart.reduce((s, i) => s + i.price * i.quantity, 0).toFixed(2)} DT</p>
              <p>Livraison : 7.00 DT</p>
              <p>Taxes (5%) : {(cart.reduce((s, i) => s + i.price * i.quantity, 0) * 0.05).toFixed(2)} DT</p>
